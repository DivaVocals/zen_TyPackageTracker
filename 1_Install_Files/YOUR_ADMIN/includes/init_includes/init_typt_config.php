...
//-- ADD VALUES TO EDIT ORDERS CONFIGURATION GROUP (Admin > Configuration > Ty Package Tracker) --
    ...
    $db->Execute($sql);
	$sql = "INSERT INTO ".DB_PREFIX."configuration VALUES (NULL, 'Package Tracking - Carrier 4 Tracking Link', 'CARRIER_LINK_4', '', 'Enter the tracking link of Carrier 4<br /> <br /><strong>Example:</strong> http://www.fedex.com/Tracking?action=track&tracknumbers=', '".$typt_configuration_id."', 150,  now(), now(), NULL, NULL)";
    $db->Execute($sql);
    ...
    $db->Execute($sql);
	$sql = "INSERT INTO ".DB_PREFIX."configuration VALUES (NULL, 'Package Tracking - Carrier 5 Tracking Link', 'CARRIER_LINK_5', '', 'Enter the tracking link of Carrier 5<br /> <br /><strong>Example:</strong> http://www.fedex.com/Tracking?action=track&tracknumbers=', '".$typt_configuration_id."', 165,  now(), now(), NULL, NULL)";
    $db->Execute($sql);
